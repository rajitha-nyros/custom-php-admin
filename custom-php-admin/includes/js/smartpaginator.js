    ...
    $.fn.extend({
        smartpaginator: function (options) {
            ...
            return this.each(function () {
                ...
                var inputPage = $('').attr('', '').keydown(function (e) {
                ...
                var btnGo = $('').attr('', '').attr('', settings.go).addClass('').click(function () { if (inputPage.val() == '') return false; else { currentPage = parseInt(inputPage.val()) - 1; navigate(currentPage); } });
                container.append(btnFirst).append(btnPrev).append(list).append(btnNext).append(btnLast).append($('<div/>').addClass('').append(inputPage).append(btnGo));
