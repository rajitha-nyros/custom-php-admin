                                                ...
                                                <p>
                                                    ...
                                                    <table class="table table-bordered table-striped" style="width:680px;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            if($row2[$i]['Tables_in_'.$database] != "zrow"  ) {  ?>
                                                            <td><a href="listadd.php?tb_name=<? echo ucwords($row2[$i]['Tables_in_'.$database]); ?>"><? echo ucwords($row2[$i]['Tables_in_'.$database]); ?></a>
                                                            </td>
                                                            ...
                                                            <ul style="list-style:none">
                                                                ...
                                                                <a href="listadd.php?tb_name=<?php echo ucwords($row2[$i]['Tables_in_'.$database]); ?>" title="List"><i class="icon-th-list"></i>
                                                                <span style="display:none">List</span></a>
                                                                </li>
                                                                <li style=" display: inline-block;">
                                                                <a href="listadd.php?tb_name=<?php echo ucwords($row2[$i]['Tables_in_'.$database]); ?>&amp;action=add" rel="tooltip" id="new" title="add new"><i
                                                                class="icon-plus"></i>
                                                                <span style="display:none">Add new</span></a>
                                                                </li>
                                                                <li style=" display: inline-block;">
                                                                <a href="listadd.php?tb_name=<?php echo ucwords($row2[$i]['Tables_in_'.$database]); ?>&amp;action=export"rel="tooltip" title="export"><i class="icon-share"></i>
                                                                <span style="display:none">Export</span></a>
                                                                </li>
                                                                <li style=" display: inline-block;">
                                                                <a href="listadd.php?tb_name=<?php echo ucwords($row2[$i]['Tables_in_'.$database]); ?>&amp;action=hist" rel="tooltip" title="history"><i
                                                                class="icon-book"></i>
